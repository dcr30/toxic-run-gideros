...
function Ground:init(groundType)
	...
	local bPath = "assets/ground_"..groundType..".png"
	if groundType == 2 then
		bPath = "assets/ground_2_" .. math.random(1,3)..".png" 
	elseif groundType == 3 then
		bPath = "assets/ground_3_" .. math.random(1,2)..".png" 
	elseif groundType == 4 then
		bPath = "assets/ground_4_" .. math.random(1,2) .. ".png"
	end
