...
background:addLayer("assets/bg1.png", 0.3)
background:addLayer("assets/bg2.png", 0.5)
background:addLayer("assets/bg3.png", 0.7)
background:addTree()
...
-- Score text
local scoreTextFont = TTFont.new("assets/MainFont.ttf", 6*gameScale)
...
local gameOver = Bitmap.new(Texture.new("assets/game_over.png"))
